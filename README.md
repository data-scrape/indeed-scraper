...
**Indeed Scraper** — Indeed Scraper - Collect public job listings and hiring-market metadata for research

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/indeed-scraper?style=social)
...
>
> **Search intent:** collect public Indeed data for account research, CRM enrichment, and lead qualification. Related topics: job data, hiring data, labor market, python, data extraction.

## What this project is for

`indeed-scraper` is an implementation-focused Python project for collecting public Indeed data. It is designed around one practical job: turn a query such as **"B2B SaaS companies"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/indeed-scraper.git
cd indeed-scraper
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "Indeed", "category": "Job Data Scrapers"}
  }
}
```
